...
MyParser5.py: This is core of the program. all you need to do is get your api toke from google for your gmail. the config file can be handled in the ui, unless using CLI.
